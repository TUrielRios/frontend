...
const downloadPDF = async () => {
  ...
  try {
    ...
    const maxValor = 10
    const barWidth = 85
    const barHeight = 0.5  // Cambié de 4 a 2
    ...
    factores.forEach((factor) => {
      ...
      yPos += 8  // Reducí el espaciado entre factores
    })
    ...
    pdf.save(`analisis-factores-${new Date().getTime()}.pdf`)
  } catch (error) {
    ...
    <div className="resultsContainer" style={{
      ...
      <div 
        ...
        style={{ 
          ...
          left: '-100vw',        // Moverlo fuera pero no tan lejos
          top: 0,
          width: '700px', 
          height: '700px',
          background: 'white',
          zIndex: -9999          // Asegurar que esté detrás de todo
        }}
      >
        <AdminChartPDF
          data={chartData}
